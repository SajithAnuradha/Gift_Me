...
function Placeorder() {
  const {getTotalCartAmount,token,gift_list,url,cartItems}=useContext(StoreContext)
  ...
  return (
    <form  onSubmit={placeOrder} className='place-order'>
      <div className="place-order-left">
        ...
        <input required  value={data.phone} onChange={onChangeHandler} name='phone'   type='text' placeholder='phone'/>
      </div>
